...
function Home() {
  return (
    <div className="home">
      <div className="about">
        <h2> Hiya! I am Akshita:)</h2>
        <div className="prompt">
          <p>A 3rd year CSE student with a passion for learning and creating!</p>
      ...
      <div className="skills">
        ...
        <ol className="list">
          <li className="item">
            <h2> Front-End</h2>
            <span>
              ReactJS, Angular, Redux, HTML, CSS, BootStrap, MaterialUI, TailwindCSS, StyledComponents
            </span>
          </li>
          <li className="item">
            <h2>Back-End</h2>
